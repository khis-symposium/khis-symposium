...
/**
 * Decorative rotating-hue glow card. Sized via CSS vars scoped to
 * `.glow-container` (--card-width/--card-radius) rather than the original
 * viewport-relative demo sizing, so it drops cleanly into a fixed-size slot
 * (e.g. the Program section's image collage) instead of a full hero card.
 */
  ...
  return (
    <>
      <style jsx>{`
        ...
        .glow-container {
          --card-color: var(--color-bg-deep, #071233);
          --card-radius: 16px;
          --border-width: 2px;
          --bg-size: 1;
          --hue: 200;
